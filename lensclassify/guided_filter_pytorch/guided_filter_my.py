...
class FastGuidedFilter_my(nn.Module):
    def __init__(self, r, eps=1e-8):
        super(FastGuidedFilter_my, self).__init__()
    ...
    def forward(self, lr_x, lr_y, hr_x):
        ...
        # --------------------------------
        # for some stange case of var_x is negative!!!!!!
        # changed by zhang shihao at 2018/11/20
        # --------------------------------
        var_x = torch.abs(var_x)
