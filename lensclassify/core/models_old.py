...
class M_Net(nn.Module):
    def __init__(self, n_classes, bn=False):
        ...
        self.conv2 = M_Conv(3, 64, kernel_size=3, bn=bn)
        self.conv3 = M_Conv(3, 128, kernel_size=3, bn=bn)
        self.conv4 = M_Conv(3, 256, kernel_size=3, bn=bn)

        # the down convolution contain concat operation
        self.down1 = M_Encoder(3, 32, kernel_size=3, bn=bn)  # 512
        ...
        self.up5 = M_Decoder(512 + 256, 256, kernel_size=3, bn=bn)
        self.up6 = M_Decoder(256 + 128, 128, kernel_size=3, bn=bn)
        self.up7 = M_Decoder(128 + 64, 64, kernel_size=3, bn=bn)
        self.up8 = M_Decoder(64 + 32, 32, kernel_size=3, bn=bn)

        # the sideoutput
        self.side_5 = nn.Conv2d(256, n_classes, kernel_size=1, padding=1, stride=1, bias=True)
        self.side_6 = nn.Conv2d(128, n_classes, kernel_size=1, padding=1, stride=1, bias=True)
        self.side_7 = nn.Conv2d(64, n_classes, kernel_size=1, padding=1, stride=1, bias=True)
        self.side_8 = nn.Conv2d(32, n_classes, kernel_size=1, padding=1, stride=1, bias=True)

        # self.side_5 = nn.Sequential(
        #     nn.Conv2d(256, n_classes, kernel_size=3, padding=1, stride=1, bias=True),
        #     nn.Sigmoid(),
        # )
        #
        # self.side_6 = nn.Sequential(
        #     nn.Conv2d(128, n_classes, kernel_size=3, padding=1, stride=1, bias=True),
        #     nn.Sigmoid(),
        # )
        #
        # self.side_7 = nn.Sequential(
        #     nn.Conv2d(64, n_classes, kernel_size=3, padding=1, stride=1, bias=True),
        #     nn.Sigmoid(),
        # )
        #
        # self.side_8 = nn.Sequential(
        #     nn.Conv2d(32, n_classes, kernel_size=3, padding=1, stride=1, bias=True),
        #     nn.Sigmoid(),
        # )
...
class VGG(nn.Module):
    def __init__(self, n_classes, bn=False):
        ...
        self.up5 = StackDecoder(512, 512, 512, kernel_size=3, bn=bn)  # 32
        self.up4 = StackDecoder(512, 512, 256, kernel_size=3, bn=bn)  # 64
        self.up3 = StackDecoder(256, 256, 128, kernel_size=3, bn=bn)  # 128
        self.up2 = StackDecoder(128, 128, 64, kernel_size=3, bn=bn)  # 256
        self.up1 = StackDecoder(64, 64, 64, kernel_size=3, bn=bn)  # 512
...
class BNM(nn.Module):
    ...
    def __init__(self, n_classes, bn=False):
        ...
        #1024
        self.down1 = StackEncoder(  3,   12, kernel_size=3, bn=bn)   #512
        self.down2 = StackEncoder( 12,   24, kernel_size=3, bn=bn)   #256
        self.down3 = StackEncoder( 24,  36, kernel_size=3, bn=bn)   #128
        self.down4 = StackEncoder(36,  64, kernel_size=3, bn=bn)   # 64
        self.down5 = StackEncoder(64,  128, kernel_size=3, bn=bn)   # 32
        # self.down6 = StackEncoder(128,  256, kernel_size=3, bn=bn)   # 16
        ...
        # self.up6 = StackDecoder(256,  256, 128, kernel_size=3, bn=bn)  # 16
        self.up5 = StackDecoder( 128, 128, 64, kernel_size=3, bn=bn)  # 32
        self.up4 = StackDecoder( 64, 64, 36, kernel_size=3, bn=bn)  # 64
        self.up3 = StackDecoder( 36, 36,  24, kernel_size=3, bn=bn)  #128
        self.up2 = StackDecoder(  24,  24,  12, kernel_size=3, bn=bn)  #256
        self.up1 = StackDecoder(  12,  12,  12, kernel_size=3, bn=bn)  #512
...
class BNM_1 (nn.Module):
    def __init__(self, n_classes, bn=False):
        ...
        #1024
        self.down1 = StackEncoder(  3,   24, kernel_size=3, bn=bn)   #512
        self.down2 = StackEncoder( 24,   64, kernel_size=3, bn=bn)   #256
        self.down3 = StackEncoder( 64,  128, kernel_size=3, bn=bn)   #128
        self.down4 = StackEncoder(128,  256, kernel_size=3, bn=bn)   # 64
        self.down5 = StackEncoder(256,  512, kernel_size=3, bn=bn)   # 32
        self.down6 = StackEncoder(512,  768, kernel_size=3, bn=bn)   # 16
        ...
        # 8
        # x_big_channels, x_channels, y_channels
        self.up6 = StackDecoder(768,  768, 512, kernel_size=3, bn=bn)  # 16
        self.up5 = StackDecoder( 512, 512, 256, kernel_size=3, bn=bn)  # 32
        self.up4 = StackDecoder( 256, 256, 128, kernel_size=3, bn=bn)  # 64
        self.up3 = StackDecoder( 128, 128,  64, kernel_size=3, bn=bn)  #128
        self.up2 = StackDecoder(  64,  64,  24, kernel_size=3, bn=bn)  #256
        self.up1 = StackDecoder(  24,  24,  24, kernel_size=3, bn=bn)  #512
        # self.weights = Variable(torch.randn([1024,1024])).cuda()
...
class Multi_Model (nn.Module):
    def __init__(self, n_classes, bn=False):
        ...
        self.down1 = StackEncoder(  9,   24, kernel_size=3, bn=bn)   #512
        self.down2 = StackEncoder( 24,   64, kernel_size=3, bn=bn)   #256
        self.down3 = StackEncoder( 64,  128, kernel_size=3, bn=bn)   #128
        self.down4 = StackEncoder(128,  256, kernel_size=3, bn=bn)   # 64
        self.down5 = StackEncoder(256,  512, kernel_size=3, bn=bn)   # 32
...
class Small (nn.Module):
    def __init__(self, n_classes, bn=False):
        ...
        #1024
        self.down1 = StackEncoder(  3,   32, kernel_size=3, bn=bn, num_groups=8)   #512
        self.down2 = StackEncoder( 32,   128, kernel_size=3, bn=bn, num_groups=8)   #256
        self.down3 = StackEncoder( 128,  256, kernel_size=3, bn=bn, num_groups=8)   #128
        self.down4 = StackEncoder(256,  512, kernel_size=3, bn=bn, num_groups=8)   # 64
        # self.down5 = StackEncoder(128,  256, kernel_size=3, bn=bn, num_groups=8)   # 32
        # self.down6 = StackEncoder(128,  256, kernel_size=3, bn=bn, num_groups=8)   # 16
        ...
        # 8
        # x_big_channels, x_channels, y_channels
        # self.up6 = StackDecoder(256,  256, 128, kernel_size=3, bn=bn, num_groups=8)  # 16
        # self.up5 = StackDecoder(512, 512, 256, kernel_size=3, bn=bn, num_groups=8)  # 16
        self.up4 = StackDecoder(512, 512, 256, kernel_size=3, bn=bn, num_groups=8)  # 16
        self.up3 = StackDecoder(256, 256, 128, kernel_size=3, bn=bn, num_groups=8)  # 32
        self.up2 = StackDecoder(128, 128, 32, kernel_size=3, bn=bn, num_groups=8)  # 32
        self.up1 = StackDecoder(32, 32, 32, kernel_size=3, bn=bn, num_groups=8)  # 256
...
class MobileNet (nn.Module):
    def __init__(self, n_classes, bn=False):
        ...
        #1024
        self.down1 = MobileNetEncoder(  3,   32, kernel_size=3, bn=bn, num_groups=8)   #512
        self.down2 = MobileNetEncoder( 32,   128, kernel_size=3, bn=bn, num_groups=8)   #256
        self.down3 = MobileNetEncoder( 128,  256, kernel_size=3, bn=bn, num_groups=8)   #128
        self.down4 = MobileNetEncoder(256,  512, kernel_size=3, bn=bn, num_groups=8)   # 64
        # self.down5 = StackEncoder(128,  256, kernel_size=3, bn=bn, num_groups=8)   # 32
        # self.down6 = StackEncoder(128,  256, kernel_size=3, bn=bn, num_groups=8)   # 16
        ...
        # self.up6 = StackDecoder(256,  256, 128, kernel_size=3, bn=bn, num_groups=8)  # 16
        # self.up5 = StackDecoder(512, 512, 256, kernel_size=3, bn=bn, num_groups=8)  # 16
        self.up4 = MobileNetDecoder(512, 512, 256, kernel_size=3, bn=bn, num_groups=8)  # 16
        self.up3 = MobileNetDecoder(256, 256, 128, kernel_size=3, bn=bn, num_groups=8)  # 32
        self.up2 = MobileNetDecoder(128, 128, 32, kernel_size=3, bn=bn, num_groups=8)  # 32
        self.up1 = MobileNetDecoder(32, 32, 32, kernel_size=3, bn=bn, num_groups=8)  # 256
        self.classify = nn.Conv2d(32, n_classes, kernel_size=1, padding=0, stride=1, bias=True)
...
class UNet512 (nn.Module):
    def __init__(self, n_classes, bn=False):
        ...
        #1024
        self.down2 = StackEncoder(  3,   64, kernel_size=3, bn=bn)   #256
        self.down3 = StackEncoder( 64,  128, kernel_size=3, bn=bn)   #128
        self.down4 = StackEncoder(128,  256, kernel_size=3, bn=bn)   #64
        self.down5 = StackEncoder(256,  512, kernel_size=3, bn=bn)   #32
        self.down6 = StackEncoder(512, 1024, kernel_size=3, bn=bn)   #16
        ...
        # 16
        # x_big_channels, x_channels, y_channels
        self.up6 = StackDecoder(1024,1024, 512, kernel_size=3, bn=bn)  # 16
        self.up5 = StackDecoder( 512, 512, 256, kernel_size=3, bn=bn)  # 32
        self.up4 = StackDecoder( 256, 256, 128, kernel_size=3, bn=bn)  # 64
        self.up3 = StackDecoder( 128, 128,  64, kernel_size=3, bn=bn)  #128
        self.up2 = StackDecoder(  64,  64,  32, kernel_size=3, bn=bn)  #256
        self.classify = nn.Conv2d(32, n_classes, kernel_size=1, padding=0, stride=1, bias=True)
...
class UNet256 (nn.Module):
    def __init__(self, n_classes, bn=False):
        ...
        #256
        self.down2 = StackEncoder(  3,   64, kernel_size=3, bn=bn)   #128
        self.down3 = StackEncoder( 64,  128, kernel_size=3, bn=bn)   # 64
        self.down4 = StackEncoder(128,  256, kernel_size=3, bn=bn)   # 32
        self.down5 = StackEncoder(256,  512, kernel_size=3, bn=bn)   # 16
        self.down6 = StackEncoder(512, 1024, kernel_size=3, bn=bn)   #  8
...
class UNet256_kernel_dgf (nn.Module):
    ...
    """
    def __init__(self, n_classes, radius=5, eps=1e-4, cn=15, bn=False):
...
class UNet128 (nn.Module):
    def __init__(self, n_classes, bn=False):
        ...
        #128
        self.down3 = StackEncoder( 3,   128, kernel_size=3, bn=bn)   # 64
        self.down4 = StackEncoder(128,  256, kernel_size=3, bn=bn)   # 32
        self.down5 = StackEncoder(256,  512, kernel_size=3, bn=bn)   # 16
        self.down6 = StackEncoder(512, 1024, kernel_size=3, bn=bn)   #  8
...
class resnet_50(nn.Module):
    def __init__(self, n_classes, pretrain=False, img_size=512):
        ...
        self.up4 = ResStackDecoder(2048, 2048, 1024, kernel_size=3, bn=bn)  # 16
        self.up3 = ResStackDecoder(1024, 1024, 512, kernel_size=3, bn=bn)  # 32
        self.up2 = ResStackDecoder(512, 512, 256, kernel_size=3, bn=bn)  # 64
        self.up1 = ResStackDecoder(256, 256, 128, kernel_size=3, bn=bn)  # 128
