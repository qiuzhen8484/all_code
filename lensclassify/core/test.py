...
parser.add_argument('--data_path', type=str, default='./data/new_data',
...
parser.add_argument('--best_model', type=str,  default='60_1e-07.pth',
...
if args.pre_all:
    ...
    print 'success download the %s'%model_path
...
with open('./data/new_data/train_dict.pkl') as f:
...
for epoch in range(args.epochs):
    ...
    if args.test_every_step and epoch and epoch%10==0:
        start = time.time()
        print("Begining test ")
        model.eval()
        save_test_img = False
        ...
        with open('./logs/unet_baseline/%s_%s_%s_log.txt' % (model_name,args.img_size,args.n_class), 'a+') as f:
