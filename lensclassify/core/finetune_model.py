...
parser.add_argument('--finetune_id', type=int, default=22,
                    help='the id of choice_model in models_list')
...
print 'This model is %s_%s_%s_%s'%(model_name,args.n_class,args.img_size,args.finetune_model)
print("Begining test ")
...
for idx, img_path in enumerate(test_img_list):
    ...
    if 'HED' in finetune_model_name or 'BNM_' in finetune_model_name:
    ...
    if save_test_img:
        ...
        save_name = os.path.join(args.results,model_name, '2Unet_'+img_path)
