...
ax.set_title('Density of all data in different Parts')
sns.violinplot(data=df)
plt.savefig('/home/intern1/qiuzhen/Works/test/lensclassify/figure/Total.png')
plt.clf()

f, ax= plt.subplots(figsize = (30, 15))
ax.set_title('Density of health data in different Parts')
sns.violinplot(data=df_health)
plt.savefig('/home/intern1/qiuzhen/Works/test/lensclassify/figure/Health.png')
plt.clf()

f, ax= plt.subplots(figsize = (30, 15))
ax.set_title('Density of sick data in different Parts')
sns.violinplot(data=df_sick)
plt.savefig('/home/intern1/qiuzhen/Works/test/lensclassify/figure/Sick.png')
plt.clf()

statical_name = ['lens', 'lens_std', 'cortex', 'cortex_std', 'nucleus', 'nucleus_std',
'lens_up', 'lens_up_std', 'lens_down', 'lens_down_std',
'cortex_up', 'cortex_up_std', 'cortex_down', 'cortex_down_std',
'nucleus_up', 'nucleus_up_std', 'nucleus_down', 'nucleus_down_std']
